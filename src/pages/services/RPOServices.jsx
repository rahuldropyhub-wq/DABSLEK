      ...
      <div className="relative z-10 w-full max-w-[1440px] mx-auto px-6 lg:px-12">
        ...
        <div className="max-w-[800px] mx-auto text-center mb-16">
          ...
          >
            ...
            <span>End-to-End Enterprise Outsourcing</span>
          </motion.div>
          <motion.h1
            variants={fadeInUp}
            initial="hidden"
          ...
          >
            Recruitment Process <span className="bg-gradient-to-r from-brand-indigo-light to-brand-violet bg-clip-text text-transparent">Outsourcing (RPO)</span>
          </motion.h1>
          <motion.p
            variants={fadeInUp}
            initial="hidden"
          ...
          >
            Outsource your entire recruiting operations to DABSLEK. We scale your company brand, implement recruiting tech stacks, and optimize the candidate pipeline.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          >
            <h2 className="font-display font-extrabold text-2xl sm:text-3xl text-brand-dark leading-snug">
              Transform Your Corporate Recruiting Engine
            </h2>
            <p className="text-brand-muted text-sm sm:text-base leading-relaxed font-sans">
              Building internally is time-consuming. Our RPO solutions align dedicated recruiters, sourcing licenses, and advanced ATS systems under your corporate brand, reducing average cost-per-hire by up to 35%.
            </p>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
              {[
                { title: "Dedicated Recruiters", desc: "Aligned team acting under your brand and workflows." },
                { title: "ATS Technology Stack", desc: "Setting up modern tracking databases and screening gear." },
                { title: "Employer Branding", desc: "Improving candidate touchpoints, responses, and reputation." },
                { title: "Data-Driven ROI", desc: "Monthly reports tracking hiring metrics, channels, and yields." }
              ].map((benefit, i) => (
          ...
          >
            <h3 className="font-display font-black text-xl mb-6">Our Enterprise RPO Process</h3>
            <ul className="flex flex-col gap-4">
              {[
                "1. Audit of Current Processes, Pipelines & Sourcing Strategy",
                "2. System Setup: ATS Deployment & Brand Message Mapping",
                "3. Sourcing Campaign Execution & Direct Interview Management",
                "4. Candidate Negotiation, Closing & Comprehensive Metrics Reporting"
              ].map((step, idx) => (
